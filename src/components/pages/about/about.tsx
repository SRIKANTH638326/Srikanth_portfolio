      ...
      <div className="max-w-[1200px] mx-auto px-6 sm:px-10 lg:px-16 flex flex-col">
        ...
        <div className="flex justify-between items-start mb-12 lg:mb-16">
          <div className="inline-block border-b-2 border-black pb-1.5">
            <span className="text-[10px] sm:text-xs font-bold tracking-[0.2em] text-black">
              About me
            </span>
          </div>
        ...
        {/* Large Quote / Bio */}
        <div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[34px] font-extrabold text-black leading-tight tracking-tight max-w-[100%]">
