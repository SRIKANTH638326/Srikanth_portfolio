        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-20 gap-10">
          ...
          <div className="flex flex-col max-w-sm gap-6 md:mt-2">
            <p className="text-gray-500 text-sm leading-relaxed font-medium">
              Over the past 1.5+ years, I&apos;ve had the opportunity to work on a wide range of design projects, collaborating with diverse teams and clients to bring creative visions to life.
            </p>
