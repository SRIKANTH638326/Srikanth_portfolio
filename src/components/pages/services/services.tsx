      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-10 lg:py-20">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 gap-10">
          <div className="max-w-xl">
            <h3 className="text-xs sm:text-sm font-bold tracking-[0px] text-gray-800 mb-6 flex items-center gap-4">
        ...
        <div className="flex flex-col xl:flex-row gap-6 sm:gap-10 items-start relative mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 flex-1 w-full">
            ...
            {/* Card 1: Dark */}
            <div className="bg-[#007ABC] text-white p-10 sm:p-12 flex flex-col justify-between min-h-[380px] rounded-3xl group transition-all cursor-pointer">
              <div className="mb-12">
